...
# --- Milvus Imports ---
# You'll need these libraries to connect to and interact with your Milvus instance
...
# This prefix is a best practice for nomic-embed-text in RAG systems.
# It tells the model to create a vector suitable for document retrieval.
SEARCH_DOCUMENT_PREFIX = "search_document: "

# --- Milvus Configuration ---
# These would typically come from environment variables in a real OCI Function
MILVUS_HOST = MILVUS_HOST
MILVUS_PORT = MILVUS_PORT
COLLECTION_NAME = COLLECTION_NAME

# Load the model and tokenizer once when the script starts.
# This avoids re-loading the large model on every function call,
# which is essential for performance in a serverless OCI Function.
...
def vectorize_and_insert(key: str, filename: str, full_text: str):
    """
